...
/**
 * Lógica compartida por los roles que únicamente consultan y crean sus propias
 * solicitudes de préstamo (Docente, Administrativo). Cada subclase solo declara
 * su propio @WebServlet y su rol permitido.
 */
public abstract class SolicitanteBaseController extends HttpServlet {
    protected final PrestamoDAO prestamoDAO = new PrestamoDAO();
    protected final ObjectMapper objectMapper = new ObjectMapper();

    protected abstract Rol rolPermitido();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!rolPermitido().name().equals(rol)) {
        ...
        try {
            List<Prestamo> prestamos = prestamoDAO.listarPorUsuario(((Usuario) session.getAttribute("usuario")).getIdUsuario());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            prestamo.setIdUsuario(((Usuario) session.getAttribute("usuario")).getIdUsuario());
